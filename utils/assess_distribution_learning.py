...
import guacamol
from utils.distribution_learning_benchmark import DistributionLearningBenchmark, DistributionLearningBenchmarkResult
from utils.distribution_matching_generator import DistributionMatchingGenerator
from utils.benchmark_suites import distribution_learning_benchmark_suite
from utils.data import get_time_string
...
def _evaluate_distribution_learning_benchmarks(model: DistributionMatchingGenerator,
    ...
    logger.info(f'Finished execution of the benchmarks')
