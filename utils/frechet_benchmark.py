...
from utils.data import get_random_subset
from utils.sampling_helpers import sample_valid_molecules
...
class FrechetBenchmark(DistributionLearningBenchmark):
    ...
    def __init__(self, training_set: List[str],
        ...
        Args:
            ...
            sample_size: how many molecules to generate the ditribution statistics from (both reference data and model)
        """
